...
def initialize_qa(vector_store):
    ...
    prompt_template = """You are an expert AI assistant analyzing PDF documents. Follow these guidelines:
...
if st.session_state.qa_chain:
            ...
            with st.spinner("🤖 Analyzing document..."):
                try:
                    ...
                    for doc in response["source_documents"]:
                        ...
                        sources.append(f"📄 Page {page_num}: {snippet}...")
    ...
    st.markdown("""
### 📘 How to Use
1. Upload a PDF document on the sidebar  
2. Ask questions about its content  
3. Get answers with referenced page numbers  
""")